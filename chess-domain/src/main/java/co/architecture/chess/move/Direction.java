package co.architecture.chess.move;

import co.architecture.chess.chessboard.tile.Tile;
import co.architecture.chess.move.config.DirectionPredicate;
import co.architecture.chess.move.general.GeneralMovePatternChecker;

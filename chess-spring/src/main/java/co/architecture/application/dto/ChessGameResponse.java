package co.architecture.application.dto;
...
public class ChessGameResponse {
    ...
    public ChessGameResponse() {
    }

    public ChessGameResponse(Long id, String chessRuleType, String gameState, String turn, Map<String, String> board, String justNowPawnJumpedTile) {
        this.id = id;
